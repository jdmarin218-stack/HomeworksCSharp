...
import '../exercises/ejercicio10.dart';

class Ejercicio10Screen extends StatefulWidget {
  const Ejercicio10Screen({super.key});

  @override
  State<Ejercicio10Screen> createState() => _Ejercicio10ScreenState();
}
...
class _Ejercicio10ScreenState extends State<Ejercicio10Screen> {
  ...
  void _calcular() {
    ...
    final ejercicio = StringLength(input);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ejercicio 10: String Length'),
      ),
      body: Padding(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '• Cuenta cada letra con un bucle for\n'
                    '• Muestra la longitud total',
