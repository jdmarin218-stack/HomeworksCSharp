...
import '../exercises/ejercicio15.dart';

class Ejercicio15Screen extends StatefulWidget {
  const Ejercicio15Screen({super.key});

  @override
  State<Ejercicio15Screen> createState() => _Ejercicio15ScreenState();
}

class _Ejercicio15ScreenState extends State<Ejercicio15Screen> {
  ...
  void _calcular() {
    ...
    final ejercicio = InRangeValidator(input);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ejercicio 15: InRange Validator'),
      ),
      body: Padding(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '• Verifica si está entre 10 y 20 (ambos incluidos)\n'
                    '• Muestra si está en rango o fuera de él',
