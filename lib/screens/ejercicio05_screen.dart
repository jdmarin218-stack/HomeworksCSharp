...
import '../exercises/ejercicio05.dart';

class Ejercicio05Screen extends StatefulWidget {
  const Ejercicio05Screen({super.key});

  @override
  State<Ejercicio05Screen> createState() => _Ejercicio05ScreenState();
}
...
class _Ejercicio05ScreenState extends State<Ejercicio05Screen> {
  ...
  void _calcular() {
    ...
    final ejercicio = MidweekDay(input);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ejercicio 05: Midweek Day'),
      ),
      body: Padding(
        ...
        child: Column(
          ...
          children: [
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '• 1-5 → muestra el día laboral correspondiente\n'
                    '• 6-7 → fuera del rango laboral',
            ...
            const Text('Ingresa un número del 1 al 7:',
