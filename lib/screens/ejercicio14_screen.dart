...
import '../exercises/ejercicio14.dart';

class Ejercicio14Screen extends StatefulWidget {
  const Ejercicio14Screen({super.key});

  @override
  State<Ejercicio14Screen> createState() => _Ejercicio14ScreenState();
}

class _Ejercicio14ScreenState extends State<Ejercicio14Screen> {
  ...
  void _calcular() {
    ...
    final ejercicio = FactorialFinder(input);
    setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Ejercicio 14: Factorial Finder'),
      ),
      body: Padding(
              ...
              child: const Column(
                ...
                children: [
                  ...
                  Text(
                    ...
                    '• Calcula su factorial con un bucle for\n'
